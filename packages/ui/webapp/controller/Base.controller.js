sap.ui.define(["sap/ui/core/Fragment", "sap/ui/core/mvc/Controller"], function (Fragment, Controller) {
   ...
   */
  const Base = Controller.extend("hacking.away.sampleapp.controller.Base", {
    onInit: function _onInit() {
      this.todoModel = this.getOwnerComponent().getModel();
      this.todoModelData = this.todoModel.getData();
    },
